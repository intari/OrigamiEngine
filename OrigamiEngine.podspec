Pod::Spec.new do |s|
  ...
  s.homepage              = "https://github.com/intari/OrigamiEngine.git"
  s.license               = 'MIT'
  s.author                = { "intari" => "dmitriy.kazimirov@viorsan.com" }
  s.source                = { :git => "https://github.com/intari/OrigamiEngine.git", :tag => "1.0.14", :submodules => true }
